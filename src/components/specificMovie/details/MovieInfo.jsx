    ...
    return (
        <>
            <div className="ratingAndTitle">
                <motion.h3 whileInView={{ scale: [0, 1] }} className="title">{info.title} - {info.release_date && info.release_date.slice(0, 4)}</motion.h3>
            ...
            <motion.p whileInView={{ scale: [0, 1] }} className="overview">{info.overview ? info.overview : "This movie doesn't have an overview."}</motion.p>
        </>
    )
}